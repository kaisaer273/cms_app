        ...
        child: Column(
          children:[Padding(
              ...
              itemBuilder: (BuildContext context, int index) {
                return MedicineCard(index: index, cartController: cartController, filteredMedicineList: filteredMedicineList,);
              });
                }),
              ),] 
        ),
...
class MedicineCard extends StatelessWidget {
  ...
  const MedicineCard({super.key, required this.index, required this.cartController, required this.filteredMedicineList});
